...
def get_extrastates():
    exs = [ss.BoolState('sought_care', default=False),
        ...
        ss.FloatArr('hhid', default=False),
...
if __name__ == '__main__':
    ...
    print('sought_care' in [s.name for s in mtb.get_extrastates()])
    print('multiplier_applied' in [s.name for s in mtb.get_extrastates()])
    print('returned_to_community' in [s.name for s in mtb.get_extrastates()])
    print('received_tpt' in [s.name for s in mtb.get_extrastates()])
    print('tb_treatment_success' in [s.name for s in mtb.get_extrastates()])
    print('tested' in [s.name for s in mtb.get_extrastates()])
    print('test_result' in [s.name for s in mtb.get_extrastates()])
    print('diagnosed' in [s.name for s in mtb.get_extrastates()])
    print('on_tpt' in [s.name for s in mtb.get_extrastates()])