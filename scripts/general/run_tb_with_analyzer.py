...
if __name__ == '__main__':
    ...
    an.validate_dwell_time_distributions(expected_distributions=expected_distributions) # This is an optional step
    # These are two of the few plots that have been added directly to the DwellTimeAnalyzer class
    an.plot_dwell_time_validation()        

    # PLOTTING:
    # If the validation is successful, the dwell time distributions are saved to a file    
    an.plot_dwell_time_validation_interactive() # This is an optional step
    
    # External plotters: use the function to save the dwell time distributions to a file and then plot them
