...
- [tutorials/tb_interventions_tutorial.ipynb](tutorials/tb_interventions_tutorial.ipynb)
- [tutorials/run_tbhiv_scens.ipynb](tutorials/run_tbhiv_scens.ipynb)
...
1. **Locally**: After installing TBsim and its dependencies
2. **In Jupyter**: Open the .ipynb files in Jupyter Notebook or JupyterLab
