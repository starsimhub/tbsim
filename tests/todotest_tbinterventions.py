...
def test_ACF():
    ...
    sim = ss.Sim( dt=7, start=ss.date('2013-01-01'), stop=ss.date('2016-12-31'), people=ppl, diseases=tb, interventions=acf, networks=net)
    sim.run()
    return
...
def test_campaign():
    ...
    tb = mtb.TB()
    sim = ss.Sim( dt=7, start=ss.date('2013-01-01'), stop=ss.date('2016-12-31'), n_agents=1000, diseases=tb, interventions=campaign)
    sim.run()
    return
